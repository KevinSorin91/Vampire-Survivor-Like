...
public class FirstPersonController : MonoBehaviour
{
    ...
    public int level = 1;
    public int xp = 0;
    public int level_up_threshold = 100;
    ...
    public bool isAlive() // For Enemy Attack
    {
...
#region HealthBar
        ...
        EditorGUILayout.Space();
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Healthbar Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        fpc.healthBar = (HealthBar)EditorGUILayout.ObjectField(new GUIContent("Health Bar", "Health Bar UI attached."), fpc.healthBar, typeof(HealthBar), true);
